![ci status](https://github.com/lib1221/django-vuejs-tutorial/actions/workflows/ci.yml/badge.svg)
...
For a detailed tutorial, checkout this [wiki](https://github.com/lib1221/django-vuejs-tutorial/wiki/Django-Vue.js-Integration-Tutorial).
...
### Steps:
1. Clone the repo with `git clone --single-branch --branch no_webpack https://github.com/lib1221/django-vuejs-tutorial.git` (You can also clone the repo normal way and checkout the **no_webpack** branch)
2. Run `pip install -r requirements.txt`
3. Run `python manage.py runserver`
